  ...
  (n.g = (function () {
    ...
    (() => {
      const t = n(755),
        e = n(486);
      let r = 0;
      t('<p>Holberton Dashboard</p>').appendTo('body'),
        t('<p>Dashboard data for the students</p>').appendTo('body'),
        t('<button>Click here to get started</button>').appendTo('body'),
        t("<p id='count'></p>").appendTo('body'),
        t('<p>Copyright - Holberton School</p>').appendTo('body'),
        t('button').on(
          'click',
          e.debounce(function () {
